...
$$.HashMapImplementation = {"":
 ...
 forEach$1: function(f) {
  ...
  for (var i = 0; i < length$; ++i) {
    ...
    !(key === (void 0)) && !(key === $.CTC10) && f.$call$2(key, $.index(this._values, i));
  }
 },
 ...
 operator$indexSet$2: function(key, value) {
  ...
  if ($.index(this._lib0_keys, index) === (void 0) || $.index(this._lib0_keys, index) === $.CTC10) this._numberOfEntries = $.add0(this._numberOfEntries, 1);
 ...
 clear$0: function() {
  ...
  for (var i = 0; i < length$; ++i) {
    $.indexSet(this._lib0_keys, i, (void 0));
 ...
 _grow$1: function(newCapacity) {
  ...
  for (var i = 0; i < capacity; ++i) {
    ...
    var t2 = oldKeys[i];
    if (t2 === (void 0) || t2 === $.CTC10) continue;
    t1 = oldValues.length;
    if (i < 0 || i >= t1) throw $.ioore(i);
    var t3 = oldValues[i];
  ...
  switch (state) {
    ...
    case 3:
      ...
      for (var i = 0; $.ltB(i, capacity); ++i) {
        ...
        if (key === (void 0) || key === $.CTC10) continue;
 ...
 _ensureCapacity$0: function() {
  var newNumberOfEntries = $.add0(this._numberOfEntries, 1);
...
$$.HashSetImplementation = {"":
 ...
 addAll$1: function(collection) {
  $.forEach(collection, new $.Closure13(this));
 },
...
$$.HashSetIterator = {"":
 ...
 _advance$0: function() {
  ...
  var entry = (void 0);
  do {
    var t2 = $.add0(this._nextValidIndex, 1);
    ...
    entry = t1[t2];
  } while ((entry === (void 0) || entry === $.CTC10));
 },
...
$$.LinkedHashMapImplementation = {"":
 ...
 forEach$1: function(f) {
  var t1 = ({});
  t1.f_11 = f;
  $.forEach(this._lib0_list, new $.Closure12(t1));
 },
 operator$index$1: function(key) {
  var t1 = this._map;
 ...
 operator$indexSet$2: function(key, value) {
  if (this._map.containsKey$1(key) === true) {
    ...
    $.addLast(this._lib0_list, $.KeyValuePair$2(key, value));
    t1 = this._map;
...
$$.DoubleLinkedQueue = {"":
 ...
 get$first: function() { return new $.Closure16(this, 'first$0'); },
...
$$.StringBufferImpl = {"":
 ...
 add$1: function(obj) {
  ...
  this._length = $.add0(this._length, $.get$length(str));
  return this;
 },
 isEmpty$0: function() {
...
$$.JSSyntaxRegExp = {"":
 ...
 firstMatch$1: function(str) {
  ...
  var matchEnd = $.add0(matchStart, $.get$length($.index(m, 0)));
...
$$.ConstantMap = {"":
 ...
 forEach$1: function(f) {
  var t1 = ({});
  t1.f_10 = f;
  $.forEach(this._keys, new $.Closure8(this, t1));
 },
 operator$index$1: function(key) {
...
$$.Contacts = {"":
 ...
 super: "Object",
 run$0: function() {
  var add_handler = new $.Closure();
  var list_handler = new $.Closure0();
  $.add$1($.document().query$1('#list').get$on().get$click(), list_handler);
  $.add$1($.document().query$1('#add').get$on().get$click(), add_handler);
 }
};
...
$$.FilteredElementList = {"":
 ...
 get$add: function() { return new $.Closure18(this, 'add$1'); },
...
$$.View_List = {"":
 ["element?"],
 super: "Object",
 View_List$1: function(contacts) {
  this.element = $.Element$tag('ul');
  for (var t1 = $.iterator(contacts); t1.hasNext$0() === true; ) {
    var t2 = t1.next$0();
    $.add$1(this.element.get$nodes(), $.Element$html('<li>' + $.S(t2.get$last_name()) + ', ' + $.S(t2.get$first_name()) + ' - ' + $.S(t2.get$phone()) + ' - ' + $.S(t2.get$email()) + '</li>'));
  }
 }
};
...
$$.View_Add = {"":
 ...
 super: "Object",
 View_Add$0: function() {
  this.element = $.Element$tag('table');
  $.forEach($.makeLiteralMap(['first_name', 'First name', 'last_name', 'Last name', 'phone', 'Phone', 'email', 'E-Mail']), new $.Closure10(this));
  var row = $.Element$tag('tr');
  var submit = $.Element$tag('td');
  $.indexSet(submit.get$attributes(), 'colspan', '2');
  submit.set$innerHTML('<button type="submit" id="submit">Submit</button>');
  $.add$1(row.get$nodes(), submit);
  $.add$1(this.element.get$nodes(), row);
 }
};

$$.Model_Contact = {"":
 ["_email", "_phone", "_last_name", "_first_name", "_id"],
 super: "Object",
 Model_Contact$values$1: function(values) {
  this._first_name = $.index(values, 'first_name');
  this._last_name = $.index(values, 'last_name');
  this._phone = $.index(values, 'phone');
  this._email = $.index(values, 'email');
 }
};
...
$$.Closure = {"":
 ...
 $call$1: function(event$) {
  ...
  var view = $.View_Add$0();
  $.clear($.document().query$1('#content').get$nodes());
  $.add$1($.document().query$1('#content').get$nodes(), view.element);
  $.add$1($.document().query$1('#submit').get$on().get$click(), new $.Closure9());
 }
};
...
$$.Closure9 = {"":
 ...
 super: "Closure17",
 $call$1: function(event$) {
  $.add($.Model_Contact$values$1($.makeLiteralMap(['first_name', $.document().query$1('input#first_name').get$value(), 'last_name', $.document().query$1('input#last_name').get$value(), 'phone', $.document().query$1('input#phone').get$value(), 'email', $.document().query$1('input#email').get$value()])));
  $.clear($.document().query$1('#content').get$nodes());
  $.add$1($.document().query$1('#content').get$nodes(), $.Element$html('<div class="success">Successfully added contact.</div>'));
 }
};
...
$$.Closure10 = {"":
 ...
 $call$2: function(key, value) {
  var row = $.Element$tag('tr');
  var label = $.Element$html('<td><label for="' + $.S(key) + '">' + $.S(value) + '</label></td>');
  var input = $.Element$html('<td><input type="text" name="' + $.S(key) + '" id="' + $.S(key) + '" /></td>');
  $.add$1(row.get$nodes(), label);
  $.add$1(row.get$nodes(), input);
  $.add$1(this.this_0.get$element().get$nodes(), row);
 }
};
...
$$.Closure11 = {"":
 ...
 super: "Closure17",
 $call$1: function(element) {
  var counter = $.add0(this.box_0.counter_1, 1);
...
Isolate.$defineClass('Closure16', 'Closure17', ['self', 'target'], {
...
$._nextProbe = function(currentProbe, numberOfProbes, length$) {
  return $.and($.add0(currentProbe, numberOfProbes), $.sub(length$, 1));
};
...
$.main = function() {
  $.add($.Model_Contact$values$1($.makeLiteralMap(['first_name', 'David', 'last_name', 'Stutz', 'phone', '0178 636 1771', 'email', 'david.stutz@rwth-aachen.de'])));
  $.Contacts$0().run$0();
};
...
$.allMatchesInStringUnchecked = function(needle, haystack) {
  ...
  for (var startIndex = 0; true; ) {
    ...
    var endIndex = $.add0(position, patternLength);
    if ($.eqB(endIndex, length$)) break;
    else {
      startIndex = $.eqB(position, endIndex) ? $.add0(startIndex, 1) : endIndex;
    }
  }
  return result;
};
...
$.add = function(contact) {
  if ($.eqNullB($.contacts)) $.contacts = [];
  $.add$1($.contacts, contact);
  contact.set$id($.indexOf$1($.contacts, contact));
};
...
$.View_List$1 = function(contacts) {
  var t1 = new $.View_List((void 0));
  t1.View_List$1(contacts);
  return t1;
};
...
$.Model_Contact$values$1 = function(values) {
  var t1 = new $.Model_Contact((void 0), (void 0), (void 0), (void 0), (void 0));
  t1.Model_Contact$values$1(values);
  return t1;
};
...
$.indexOf0$bailout = function(state, env0, env1, env2, env3) {
  ...
  switch (state) {
    ...
    case 2:
      state = 0;
      for (var i = startIndex; $.ltB(i, endIndex); i = $.add0(i, 1)) {
